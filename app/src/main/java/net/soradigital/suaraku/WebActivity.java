    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getExtras() != null){
            try{
                ...
                int news_id = bundle.getInt("news_id");
                String PEM_CODE = sessionObj.getString("PEM_CODE");
                String url = apiHelper.getUrl()+"&datatype=news&cmd=read_berita&pem_code="+PEM_CODE+"&news_id="+news_id;
                Log.d(TAG,url);
                webView.loadUrl(url);
            }catch (Exception e){
                e.printStackTrace();
