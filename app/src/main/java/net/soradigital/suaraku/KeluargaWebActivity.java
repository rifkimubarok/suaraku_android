    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getExtras() != null){
            try{
                ...
                reg_code = sesi_obj.getString("ACC_KOWIL");
                ...
                String url = apiHelper.getUrl()+"&datatype=update_profile&cmd=get_gui_profile&regcode="+reg_code+"&acc_noreg="+acc_noreg
                        +"&isfamily=true&pem_parrent="+PEM_PARENT;
                webView.loadUrl(url);
            ...
            try {
                ...
                String url = apiHelper.getUrl()+"&datatype=update_profile&cmd=get_gui_profile&regcode="+reg_code+"&acc_noreg="+ACC_NOREG+"&isfamily=true";
                Log.d(TAG,url);
                webView.loadUrl(url);
            }catch (Exception e){
                e.printStackTrace();
...
//            chooserIntent.putExtra(Intent.EXTRA_TITLE, "Image Chooser");
    ...
    class customView extends WebViewClient {
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            Log.d(TAG,"Ini adalah pesan ketika perintah berhasil dieksekusi.");
        }
    }
